...
let config = {
    ...
    build: {
        ...
        index: path.resolve(__dirname, `../../${appConfig.build.dist}/${appConfig.build.projectName ? appConfig.build.projectName + '/' : ''}index.html`),

        // Paths
        assetsRoot: path.resolve(__dirname, `../../${appConfig.build.dist}/${appConfig.build.projectName || ''}`),
        assetsSubDirectory: 'static',
        assetsPublicPath: appConfig.build.publicPath,
